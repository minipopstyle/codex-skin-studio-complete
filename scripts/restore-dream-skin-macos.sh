...
if [ "$UNINSTALL" = "true" ]; then
  /bin/rm -f "$HOME/Desktop/Codex Skin Studio.command"
  /bin/rm -f "$HOME/Desktop/Codex Skin Studio - Customize.command"
  /bin/rm -f "$HOME/Desktop/Codex Skin Studio - Verify.command"
  /bin/rm -f "$HOME/Desktop/Codex Skin Studio - Restore.command"
fi

printf 'Codex Skin Studio was removed and the requested macOS restore actions completed successfully.\n'

...
# Fast local status. No codesign / CDP probes by default.
...
# Keep this check deliberately shell/ps-only so status does not perform
# codesign, CDP, or Node startup. A live PID
